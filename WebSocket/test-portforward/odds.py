    ...
    if pooltotalsoup is not None:
        ...
        for i in range(numofhorse):
            ...
            for j in range(numofhorse):
                try:
                    ...
                    # if i + 1 <= 9:
                    #     if j + 1 <= 9:  # 1-2
                    #         Qodds[i][j] = Qodds[i][j][4:-2]
                    #     else:  # 1-11
                    #         Qodds[i][j] = Qodds[i][j][5:-2]
                    # else:
                    #     if j + 1 <= 9:  # 13-8
                    #         Qodds[i][j] = Qodds[i][j][5:-2]
                    #     else:  # 13-13
                    #         Qodds[i][j] = Qodds[i][j][6:-2]
                except:
                    pass
        ...
        for i in range(len(Qodds)):
            for j in range(len(Qodds[i])):
                index = Qodds[i][j].index("=")
                Qodds[i][j] = Qodds[i][j][index+1:]
        # print(Qodds)
        ...
        if Poddssoup is not None:
            ...
            for i in range(numofhorse):
                ...
                for j in range(numofhorse):
                    try:
                        ...
                        # if i + 1 <= 9:
                        #     if j + 1 <= 9:  # 1-2
                        #         Podds[i][j] = Podds[i][j][4:-2]
                        #     else:  # 1-11
                        #         Podds[i][j] = Podds[i][j][5:-2]
                        # else:
                        #     if j + 1 <= 9:  # 13-8
                        #         Podds[i][j] = Podds[i][j][5:-2]
                        #     else:  # 13-13
                        #         Podds[i][j] = Podds[i][j][6:-2]
                    except:
                        pass
            ...
            for i in range(len(Podds)):
                for j in range(len(Podds[i])):
                    index = Podds[i][j].index("=")
                    Podds[i][j] = Podds[i][j][index + 1:]
            # print(Podds)
